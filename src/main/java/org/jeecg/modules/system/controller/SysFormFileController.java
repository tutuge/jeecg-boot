...
public class SysFormFileController extends JeecgController<SysFormFile, ISysFormFileService> {
    ...
    @Operation(summary = "表单评论文件-分页列表查询", description = "表单评论文件-分页列表查询")
    ...
    @Operation(summary = "表单评论文件-添加", description = "表单评论文件-添加")
    ...
    @Operation(summary = "表单评论文件-编辑", description = "表单评论文件-编辑")
