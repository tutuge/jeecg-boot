...
public class SysFillRuleController extends JeecgController<SysFillRule, ISysFillRuleService> {
    ...
    @Operation(summary = "填值规则-分页列表查询", description = "填值规则-分页列表查询")
    ...
    @Operation(summary = "填值规则-添加", description = "填值规则-添加")
    ...
    @Operation(summary = "填值规则-通过id删除", description = "填值规则-通过id删除")
    ...
    @Operation(summary = "填值规则-批量删除", description = "填值规则-批量删除")
    ...
    @Operation(summary = "填值规则-通过id查询", description = "填值规则-通过id查询")
