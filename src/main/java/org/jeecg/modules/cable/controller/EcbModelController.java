...
import .org.jeecg.modules.cable.entity.EcbModel;
import .org.jeecg.modules.cable.service.IEcbModelService;
...
@Api(tags="系统型号管理")
@RestController
@RequestMapping("/org.jeecg.modules.cable/ecbModel")
public class EcbModelController extends JeecgController<EcbModel, IEcbModelService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "系统型号管理-分页列表查询")
	@ApiOperation(value="系统型号管理-分页列表查询", notes="系统型号管理-分页列表查询")
	...
	public Result<?> queryPageList(EcbModel ecbModel,
		...
		Page<EcbModel> page = new Page<EcbModel>(pageNo, pageSize);
	 ...
	 * @return
	 */
	@AutoLog(value = "系统型号管理-添加")
	@ApiOperation(value="系统型号管理-添加", notes="系统型号管理-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "系统型号管理-编辑")
	@ApiOperation(value="系统型号管理-编辑", notes="系统型号管理-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "系统型号管理-通过id删除")
	@ApiOperation(value="系统型号管理-通过id删除", notes="系统型号管理-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "系统型号管理-批量删除")
	@ApiOperation(value="系统型号管理-批量删除", notes="系统型号管理-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "系统型号管理-通过id查询")
	@ApiOperation(value="系统型号管理-通过id查询", notes="系统型号管理-通过id查询")
