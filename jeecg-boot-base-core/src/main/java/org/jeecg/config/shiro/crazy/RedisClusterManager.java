...
public class RedisClusterManager implements IRedisManager {
     ...
     */
    private ConnectionPoolConfig jedisPoolConfig = new ConnectionPoolConfig();
    ...
    private Set<byte[]> getKeysFromClusterNode(ConnectionPool jedisPool, byte[] pattern) {
        ...
        try {
            ...
            do {
                scanResult = jedis.executeCommand(commandObjects.scan(cursor, params));
    ...
    private long getDbSizeFromClusterNode(ConnectionPool jedisPool, byte[] pattern) {
        long dbSize = 0L;
        Connection jedis = jedisPool.getResource();
    ...
    public ConnectionPoolConfig getJedisPoolConfig() {
        return jedisPoolConfig;
    }

    public void setJedisPoolConfig(ConnectionPoolConfig jedisPoolConfig) {
