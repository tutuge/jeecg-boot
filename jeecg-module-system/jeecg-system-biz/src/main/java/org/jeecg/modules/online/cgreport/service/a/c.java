 ...
 public class c extends ServiceImpl<OnlCgreportHeadMapper, OnlCgreportHead> implements IOnlCgreportHeadService {
   ...
   public Map<String, Object> executeSelectSql(String sql, String onlCgreportHeadId, Map<String, Object> params) throws SQLException {
     ...
     String str1 = null;
     try {
       str1 = eTableConfig.getDatabaseType();
     } catch (AException a) {
       a.printStackTrace();
     }
     ...
     if (arrayList.size() > 0) {
       ...
       if (list2.size() < arrayList.size()) {
         ...
         boolean bool2 = list2.stream().anyMatch(paramOnlCgreportItem -> "id".equalsIgnoreCase(paramOnlCgreportItem.getFieldName()));
         if (bool1 && !bool2) {
     ...
     bConstant b = new bConstant(str2, str1);
     String str3 = b.a7(arrayList1, params);
   ...
   public Map<String, Object> executeSelectSqlDynamic(String dbKey, String sql, Map<String, Object> params, String onlCgreportHeadId) {
     ...
     String str4 = org.jeecg.modules.online.cgform.enums.c.b(dynamicDataSourceModel.getDbType());
     bConstant b = new bConstant(str3, str4);
     b.setDaoType("jdbcTemplate");
     String str5 = b.a7(arrayList, params);
   ...
   private List<String> a(String paramString1, String paramString2) throws SQLException, AException {
     ...
     if (StringUtils.isNotBlank(paramString2)) {
       ...
       if (list.size() < 1) {
         if (!paramString1.contains("*"))
           try {
             set = bConstant.a7(paramString1).keySet();
           } catch (Exception exception) {}
         if (set == null)
           throw new JeecgBootException("该报表sql没有数据");
       } else {
   ...
   public Map<String, Object> queryCgReportConfig(String reportId) {
     ...
     if (eTableConfig.a()) {
       hashMap.put("main", bConstant.a7(map));
   ...
   public Map<String, Object> queryColumnInfo(String code, boolean queryDict) {
     ...
     ((QueryWrapper)((QueryWrapper)queryWrapper.eq("cgrhead_id", code)).eq("is_show", Integer.valueOf(1))).orderByAsc("order_num");
     ...
     for (OnlCgreportItem onlCgreportItem : list) {
       ...
       if (str2 != null && !"".equals(str2))
         if (queryDict) {
           List<DictModel> list1 = queryColumnDict(onlCgreportItem.getDictCode(), (JSONArray)null, (String)null);
     ...
     hashMap1.put("isGroupTitle", Boolean.valueOf(bool));
     return (Map)hashMap1;
   }
