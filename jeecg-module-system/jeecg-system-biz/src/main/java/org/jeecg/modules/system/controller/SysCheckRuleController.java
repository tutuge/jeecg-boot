...
public class SysCheckRuleController extends JeecgController<SysCheckRule, ISysCheckRuleService> {
    ...
    @Operation(summary = "编码校验规则-分页列表查询", description = "编码校验规则-分页列表查询")
    ...
    @Operation(summary = "编码校验规则-通过Code校验传入的值", description = "编码校验规则-通过Code校验传入的值")
    ...
    @Operation(summary = "编码校验规则-添加", description = "编码校验规则-添加")
    ...
    @Operation(summary = "编码校验规则-编辑", description = "编码校验规则-编辑")
