 ...
 public class h implements IOnlineJoinQueryService {
     ...
     if (integer.intValue() == -521) {
       ...
       if (list == null || list.size() == 0) {
         ...
         if (ignoreSelectSubField)
           list = b(list);
         hashMap.put("records", bConstant.a(list, map2.values()));
       }
       if (ignoreSelectSubField)
   ...
   private String a(List<org.jeecg.modules.online.cgform.model.h> paramList) {
     ...
     return " ORDER BY " + String.join(",", (Iterable)arrayList);
   }
     ...
     if (paramJSONArray != null)
       for (byte b = 0; b < paramJSONArray.size(); b++) {
         ...
         if (arrayOfString.length == 1) {
           if (paramBoolean1 && b.c(str, paramList)) {
           ...
           if (paramString2.equalsIgnoreCase(arrayOfString[0]) &&
             ...
             b.a(paramStringBuilder, str2, jSONObject, paramMatchTypeEnum, null, bool);
             bool = false;
           }
         }
       }
   ...
   private boolean a(f paramf) {
     if (paramf.a())
       return true;
     List list = paramf.getSelectFieldList();
     if (list != null && list.size() > 0)
       for (OnlCgformField onlCgformField : list) {
   ...
   private bConstant a(f paramf, JSONArray paramJSONArray, String paramString, bConstant paramb) {
     String str = paramf.getTableName();
     boolean bool = paramf.a();
     List list = paramf.getAllFieldList();
     ...
     if (paramJSONArray != null) {
       ...
       if (arrayList.size() > 0) {
         String str1 = paramf.getAlias() + ".";
         bConstant b2 = new bConstant(str1, true, paramString);
   ...
   public e getQueryInfo(OnlCgformHead head, Map<String, Object> params, boolean ignoreSelectSubField, boolean isNewExport) {
     ...
     for (f f : list) {
       ...
       bConstant b1 = new bConstant(str7);
       b1.setTableName(str9);
       b1.setNeedList(null);
       b1.setFirst(false);
       List list5 = bConstant.g(list3);
       ...
       String str11 = "";
       bConstant b2 = a(f, jSONArray, matchTypeEnum.getValue(), b1);
       if (b2 != null) {
   ...
   public XSSFWorkbook handleOnlineExport(OnlCgformHead head, Map<String, Object> params) {
     ...
     List<ExcelExportEntity> list1 = bConstant.a(list, "id", this.upLoadPath);
     boolean bool2 = false;
     while (bool1) {
       ...
       List list2 = bConstant.d(iPage.getRecords());
   ...
   public void addAllSubTableDate(String subTable, Map<String, Object> params, List<Map<String, Object>> result, List<ExcelExportEntity> entityList, boolean subEntityExist) {
     ...
     if (!subEntityExist) {
       ...
       excelExportEntity.setList(bConstant.a(list, "id", this.upLoadPath));
