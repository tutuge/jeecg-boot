...
public final class a extends Dialect {
    public a() {
        ...
        registerFunction("concat", new VarArgsSQLFunction((Type) StandardBasicTypes.STRING, "", "||", ""));
        registerFunction("mod", new SQLFunctionTemplate((Type) StandardBasicTypes.INTEGER, "?1 % ?2"));
        registerFunction("substr", new StandardSQLFunction("substr", (Type) StandardBasicTypes.STRING));
        registerFunction("substring", new StandardSQLFunction("substr", (Type) StandardBasicTypes.STRING));
    }
