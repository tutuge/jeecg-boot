...
import org.jeecg.modules.online.cgform.dConstants.cConstant;
...
public class OnlineServiceImpl implements IOnlineService {
    ...
    public Col queryOnlineConfig(OnlCgformHead head, String username) {
        ...
        List<String> list2 = head.getSelectFieldList();
        for (OnlCgformField onlCgformField : list) {
            ...
            if (oConvertUtils.isNotEmpty(str3) && oConvertUtils.isNotEmpty(str2)) {
                cTable c = new cTable(str1, str3);
                arrayList2.add(c);
            }
            if (onlCgformField.getIsShowList() == null || 1 != onlCgformField.getIsShowList())
                continue;
            if ("id".equals(str1))
                continue;
        ...
        if (onlCgformEnhanceJs != null && oConvertUtils.isNotEmpty(onlCgformEnhanceJs.getCgJs())) {
            String str1 = cConstant.b(onlCgformEnhanceJs.getCgJs(), list3);
            b.setEnhanceJs(str1);
        }
    ...
    public JSONObject queryOnlineFormObj(OnlCgformHead head, OnlCgformEnhanceJs onlCgformEnhanceJs) {
        ...
        cConstant.a(onlCgformEnhanceJs, head.getTableName(), list);
        ...
        if (onlCgformEnhanceJs != null && oConvertUtils.isNotEmpty(onlCgformEnhanceJs.getCgJs())) {
            String str = cConstant.c(onlCgformEnhanceJs.getCgJs(), list1);
            onlCgformEnhanceJs.setCgJs(str);
            jSONObject1.put("enhanceJs", cConstant.a(onlCgformEnhanceJs.getCgJs()));
        }
        return jSONObject1;
    }
    ...
    public String queryEnahcneJsString(String code, String type) {
        ...
        if (onlCgformEnhanceJs != null && oConvertUtils.isNotEmpty(onlCgformEnhanceJs.getCgJs()))
            str = cConstant.b(onlCgformEnhanceJs.getCgJs(), (List) null);
        return str;
    }
    ...
    private JSONObject a(String paramString1, List<String> paramList, boolean paramBoolean, String paramString2) {
        LambdaQueryWrapper<OnlCgformField> lambdaQueryWrapper = Wrappers.lambdaQuery(OnlCgformField.class)
                .eq(OnlCgformField::getCgformHeadId, paramString1)
                .and(paramLambdaQueryWrapper ->
                        paramLambdaQueryWrapper.eq(OnlCgformField::getIsShowList, 1))
                .or()
        ...
        JSONObject jSONObject = bConstant.getId(list, (List) null, null);
    ...
    private JSONObject a(OnlCgformHead paramOnlCgformHead) {
        ...
        List<String> list = this.onlAuthPageService.queryHideCode(paramOnlCgformHead.getId(), true);
        if (list != null && list.indexOf("update") >= 0)
            jSONObject.put("form_disable_update", Boolean.TRUE);
        if (paramOnlCgformHead.getTableType() == 2) {
            ...
            if (oConvertUtils.isNotEmpty(str)) {
                ...
                if (arrayList.size() > 0) {
                    ...
                    for (OnlCgformHead onlCgformHead : arrayList) {
                        ...
                        cConstant.b(onlCgformEnhanceJs, onlCgformHead.getTableName(), list1);
                        ...
                        if (1 == onlCgformHead.getRelationType()) {
                            jSONObject2 = bConstant.getId(list1, list2, null);
                        } else {
                            jSONObject2.put("columns", bConstant.getId(list1, list2));
            ...
            if (onlCgformEnhanceJs != null && oConvertUtils.isNotEmpty(onlCgformEnhanceJs.getCgJs()))
                jSONObject.put("enhanceJs", cConstant.a(onlCgformEnhanceJs.getCgJs()));
        }
        return jSONObject;
    }
    ...
    private OnlColumn a(OnlCgformField paramOnlCgformField, Map<String, List<DictModel>> paramMap, List<HrefSlots> paramList) {
        ...
        if ("link_down".equals(str3)) {
            ...
            try {
                ...
                logger.warn("联动组件配置错误!", exception.getMessage());
            }
        }
    ...
    private List<OnlColumn> a(OnlCgformHead paramOnlCgformHead, Map<String, List<DictModel>> paramMap, List<HrefSlots> paramList, Map<String, Integer> paramMap1) {
        ...
        if (j == 2) {
            ...
            if (str != null && !"".equals(str)) {
                String[] arrayOfString = str.split(",");
                for (String str1 : arrayOfString) {
                    LambdaQueryWrapper<OnlCgformHead> lambdaQueryWrapper = Wrappers.lambdaQuery(OnlCgformHead.class).eq(OnlCgformHead::getTableName, str1);
                    ...
                    if (onlCgformHead != null) {
                        ...
                        for (OnlCgformField onlCgformField : list1) {
                            if (1 != onlCgformField.getIsShowList() && 1 != onlCgformField.getIsQuery().intValue())
                                continue;
