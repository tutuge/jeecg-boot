...
public class aConstant extends ExcelDataHandlerDefaultImpl {
    ...
    public aConstant(List<OnlCgformField> paramList, String paramString1, String paramString2) {
        this.a = a(paramList);
        this.c = paramString1;
        this.d = "online";
        this.e = paramString2;
        this.b = SpringContextUtils.getBean(ISysBaseAPI.class);
    }
    ...
    public void setMapValue(Map<String, Object> map, String originKey, Object value) {
        ...
        if (value instanceof Double) {
            ...
            String str1 = bConstant.getId(arrayOfByte, this.c, this.d, this.e);
            if (str1 != null)
                map.put(str, str1);
        } else {
