...
public class aUtil {
    ...
    public boolean a(DbType paramDbType, aUtil parama) {
    ...
    public boolean a(Object paramObject, DbType paramDbType) {
        if (paramObject == this)
            return true;
        if (!(paramObject instanceof aUtil))
            return false;
        aUtil a1 = (aUtil) paramObject;
        if (!a(paramDbType, a1))
            return false;
    ...
    public boolean a(aUtil parama) {
        if (parama == this)
            return true;
        return a(this.f, parama.getComment());
    }

    public boolean b(aUtil parama) {
        if (parama == this)
            return true;
        return a(this.f, parama.getComment());
    }
