 ...
 public class b implements IOnlCgreportAPIService {
   ...
   public Map<String, Object> getData(String id, String code, Map<String, Object> params) {
     ...
     if (oConvertUtils.isNotEmpty(id)) {
       ...
       onlCgreportHead = (OnlCgreportHead)this.onlCgreportHeadService.getOne((Wrapper)lambdaQueryWrapper);
     } 
   ...
   public Workbook getReportWorkbook(String reportId, Map<String, Object> params) {
     LambdaQueryWrapper lambdaQueryWrapper = (LambdaQueryWrapper)(new LambdaQueryWrapper()).eq(OnlCgreportItem::getCgrheadId, reportId);
